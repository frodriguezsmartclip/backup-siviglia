define(["dojo/_base/kernel","dojo/_base/lang","dojo/_base/window","dojo/_base/declare",
    ...
    "dojox/layout/ContentPane","dojox/layout/ResizeHandle","dojo/text!dojox/layout/resources/FloatingPane.html","dojox/layout/Dock"], function(
    ...
    return declare([ ContentPane, TemplatedMixin ],{
        ...
        postCreate: function(){
                ...
                moveable.onMove=function(mover, leftTop /*=====, e =====*/){
                    // summary:
