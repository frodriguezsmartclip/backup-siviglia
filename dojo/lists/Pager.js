define(["dojo/aspect", "dojo/_base/array", "dojo/_base/declare", "dojo/dom", "dojo/dom-attr", "dojo/dom-class", "dojo/dom-construct", "dojo/dom-geometry", "dojo/dom-style", "dojo/fx", "dojo/_base/kernel", "dojo/keys",
	"dojo/_base/lang", "dojo/on", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "./PagerItem", "dojo/text!./templates/Pager.html"],
...
return declare("dojox.widget.Pager",
	...
	iconNext: "",
                ...
                iconPage: require.toUrl("Siviglia/lists/templates/images/pageInactive.png"),
                iconPageActive: require.toUrl("Siviglia/lists/templates/images/pageActive.png"),
    ...
    generateContentItem:function(item,cnt)
    {
        return {domNode:domConstruct.create('div', {
	...
	generatePagerItem: function(/*item */ item, /* Number */ cnt){
		...
		return new pagerItem({
		  ...
		  }, this.generateContentItem(item,cnt).domNode);
	},
